...
{ 
    ...
    void Start()
    {
	 ...
	 void Awake()
 {
   int gameStatusCount = FindObjectsOfType<ran2>().Length;
   ...
   DontDestroyOnLoad(this.gameObject);
	   ...
	   PlayerPrefs.SetString(smallsection,smallsec);
		...
		string sqlQuery="SELECT count(*) FROM bedroom" ;
		string sqlQuery2="SELECT * FROM bedroom ";
